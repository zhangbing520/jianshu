 ...
 * @Description: 
 * @Autor: zhangbing
 * @Date: 2022-03-29 20:29:08
 * @LastEditors: zhangbing
 * @LastEditTime: 2022-04-01 15:43:41
 */
...
class PriceForm extends React.Component {
  ...
  render() {
    const { item, onFormSubmit, onCancelSubmit } = this.props
    ...
    return (
      <form>
        ...
        <button type="submit" className="btn btn-primary mr-3" onClick={this.sumbitForm}>提交</button>
        <button className="btn btn-secondary" onClick={onCancelSubmit}> 取消 </button>
